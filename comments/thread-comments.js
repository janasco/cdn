$(function() {
  var url = window.location.href,
    ...
    id = '',
    li = '',
    m = 5, // The number of comments displayed on the main display
    n = str.length,
    k = 0,
    p = 0
	$("#top-continue").removeClass("hidden");
  // Call iframe when clicking on reply button
  ...
  // Call the iframe when clicking on the bottom Add Comment button
  ...
  // Handles the browser address if there is a link to the comment
